...
{{-- <h3> {{$title}}</h3> --}}
  <div style="line-height: 140%; text-align: justify; word-wrap: break-word;">
    <p style="font-size: 20px; line-height: 140%; margin-bottom:10px"><strong> Thank You for Contacting Us!</strong>,</p>
<p style="font-size: 14px; line-height: 140%;">Your message has been successfully sent. We appreciate your interest in Visaro and will get back to you within the next 24 hours.</p>

<p style="font-size: 14px; line-height: 140%;">Please feel free to reach out should you need any further questions or need additional assistance.</p>
<p style="font-size: 14px; line-height: 140%;">Thank you for choosing Visaro. We're here to help!.</p>
