...
<head>
<link rel="stylesheet" href="{{asset('css/all.min.css')}}" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
<!--[if gte mso 9]>
<xml>
...
table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_image_1 .v-src-width { width: auto !important; } #u_content_image_1 .v-src-max-width { max-width: 42% !important; } #u_content_text_1 .v-container-padding-padding { padding: 60px 10px 10px !important; } #u_content_button_1 .v-container-padding-padding { padding: 10px !important; } #u_content_button_1 .v-size-width { width: 65% !important; } #u_content_text_3 .v-container-padding-padding { padding: 10px 10px 30px !important; } #u_content_text_4 .v-container-padding-padding { padding: 10px 10px 30px !important; } }
    </style>
...
<body class="clean-body u_body" style="font-family: 'Aeonik';
font-style: normal;
font-weight: 400;
font-size: 20px;
line-height: 30px; margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #ecf0f1;color: #000000">
...
{{-- <h3> {{$title}}</h3> --}}
  <div style="line-height: 140%; text-align: justify; word-wrap: break-word;">
    <p style="font-size: 12px; line-height: 140%; margin-bottom:10px"><strong> Welcome {{$name}}</strong>,</p>
<p style="font-size: 14px; line-height: 140%;">You have been successfully onboarded on our platform, kindly click the link below to access your dashbaord with the credentials below</p>
<h6>Email: {{$email}}</h6>
<h6>Password: {{$password}}</h6>
<a href="https://partner.visaro.ng" target="_blank" class="v-button v-size-width" style="box-sizing: border-box;display: inline-block;font-family:'Open Sans',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #EA5C29; border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px; width:30%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
    <span style="display:block;padding:10px 20px;line-height:120%;"><span style="font-size: 14px; line-height: 16.8px;">Access Dashboard</span></span>
  </a>
...
<div align="left">
  ...
  <p style="font-size: 14px; line-height: 140%; margin-top:30px; margin-bottom:30px">
If you did not take this action, please contact us immediately at info@visarong.com</p>



 <p style="font-size: 11px; line-height: 140%; padding-right:100px; padding-left:100px; margin-top:30px; color:grey">
Feel secure while shopping globally today, available on Android and iOS. Copyright © 2023 Visaro Technologies Limited. All rights reserved.
 </p>
...
<p style="font-family: 'Bw Gradual';
font-style: normal;
font-weight: 500;
font-size: 18px;
line-height: 18px;"><strong> Connect to us</strong></p>
