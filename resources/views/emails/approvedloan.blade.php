...
{{-- <h3> {{$title}}</h3> --}}
  <div style="line-height: 140%; text-align: justify; word-wrap: break-word;">
    <p style="font-size: 12px; line-height: 140%; margin-bottom:10px"><strong> Congratulations {{ $user->firstname }}</strong>,</p>
<p style="font-size: 14px; line-height: 140%;">Your loan request with reference {{ $loan->reference }} has been approved, Kindly visit the app to complete the transaction</p>
