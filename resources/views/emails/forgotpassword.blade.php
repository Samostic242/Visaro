...
<p style="font-size: 14px; line-height: 140%;">A request was initiated to reset your password, kindly make use of the OTP below to complete the request</p>

<p style="font-size: 14px; line-height: 140%;">
Note: This OTP is valid for 5 minutes from the time it was sent to you and can only be used once. Keep it safe.</p>
